...
export default function middleware(req) {
  ...
  if (!userVerify && url.includes('/customer')) {
    return NextResponse.redirect('http://linnric/login');
  }
  ...
  if (userVerify && url.includes('/login')) {
    ...
    return NextResponse.redirect('http://linnric/customer/active');
  }
  ...
  if (writerVerify && url.includes('/writerlogin')) {
    ...
    return NextResponse.redirect('http://linnric/writer/availableorders');
  }

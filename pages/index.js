...
const navigation = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/linnric45/',
    icon: (props) => (
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/omullo_frank',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="relative bg-gray-50 h-auto dark:bg-[#1F2735]">
        ...
        >
          <motion.div
            ...
            className="h-56"
          >
            <h2 className="font-bold text-4xl">Some of our best writers</h2>
          </motion.div>
          ...
          <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <div className="mt-8 md:order-1 md:mt-0">
              <p className="text-center text-base dark:text-gray-100 dark:hover:text-gray-500">
                &copy; 2023 Linnric, Inc. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
